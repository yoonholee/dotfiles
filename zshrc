...
alias nvidia="gpustat --color -p --gpuname-width 0 --watch"
...
alias tboard="tensorboard --host 0.0.0.0 --port 40050 --window_title sandbox --logdir ~/repos/NCv2/sine_regression/logs/"

# Path to your oh-my-zsh installation.
export ZSH="/home/eddy/.oh-my-zsh"
